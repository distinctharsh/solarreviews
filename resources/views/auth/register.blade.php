    ...
    <main class="register-page">
        <div class="register-shell">
            ...
            <section class="register-form">
                ...
                <form id="googleRegisterForm" method="POST" action="{{ route('auth.google.register.redirect') }}" class="d-none">
                    @csrf
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (googleBtn && googleForm) {
            googleBtn.addEventListener('click', () => {
                const selectedType = form.querySelector('input[name="user_type_id"]:checked');
                const phoneValue = (document.getElementById('phone')?.value || '').trim();

                let ok = true;

                const typeErrorHolder = document.querySelector('[data-error="user_type_id"]');
                if (!selectedType) {
                    ok = false;
                    if (typeErrorHolder) typeErrorHolder.textContent = 'Please pick an option';
                } else if (typeErrorHolder) {
                    typeErrorHolder.textContent = '';
                }

                const phoneErrorHolder = document.querySelector('[data-error="phone"]');
                if (!phoneValue) {
                    ok = false;
                    if (phoneErrorHolder) phoneErrorHolder.textContent = 'This field is required';
                } else if (phoneErrorHolder) {
                ...
                googleForm.querySelector('input[name="user_type_id"]').value = selectedType ? selectedType.value : '';
                googleForm.querySelector('input[name="phone"]').value = phoneValue;
