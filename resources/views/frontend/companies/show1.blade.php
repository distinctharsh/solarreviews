    ...
    <div class="left">
        ...
        <div class="info">
            ...
            <div class="actions d-flex gap-2">
                ...
                <!-- Get Quote Button -->
                <button type="button" 
                        class="nav-link fw-medium nav-btn-primary bg-white text-dark" 
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title text-white" id="quoteModalTitle">Get a Free Quote</h5>
                            <button type="button" class="btn-close text-white outline" data-bs-dismiss="modal" aria-label="Close">
                                <i class="fas fa-close"></i>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p class="text-muted mb-4">Fill out the form below and a representative from {{ $company->name }} will contact you shortly.</p>
                            ...
                            <form id="quoteForm" class="needs-validation" novalidate>
                                ...
                                <div class="mb-4">
                                    <label for="message" class="form-label">Additional Details (Optional)</label>
            ...
            <script>
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    // Close on X button
                    const closeButton = quoteModal.querySelector('.quote-modal__close');
                    if (closeButton) {
                    ...
                    if (quoteForm) {
                        quoteForm.addEventListener('submit', function(e) {
                            ...
                            // Example fetch request (uncomment and implement your endpoint)
                            /*
