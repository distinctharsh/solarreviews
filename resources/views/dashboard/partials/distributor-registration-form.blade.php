...
<section class="bg-white rounded-2xl shadow p-6 space-y-8">
    ...
    @if (session('status') === 'distributor-profile-submitted')
        <div class="rounded-xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-800">
            Distributor profile submitted successfully. Our team will review it shortly.
        </div>
    @endif

    <form method="POST" action="{{ route('dashboard.distributor-profile.store') }}" enctype="multipart/form-data" class="space-y-10">
        @csrf
        ...
        <div class="space-y-6">
            ...
            <div class="grid gap-5 md:grid-cols-2">
                <div>
                    ...
                    <input type="text" name="owner_name" class="w-full rounded-xl border-slate-200 focus:border-amber-400 focus:ring-amber-400" required>
                </div>
                <div>
                    <label class="{{ $labelClass }}">Phone*</label>
                    <input type="text" name="phone" class="w-full rounded-xl border-slate-200 focus:border-amber-400 focus:ring-amber-400" required>
                </div>
                <div>
                    <label class="{{ $labelClass }}">Email*</label>
                    <input type="email" name="email" class="w-full rounded-xl border-slate-200 focus:border-amber-400 focus:ring-amber-400" required>
                </div>
                <div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="address" rows="2" class="w-full rounded-xl border-slate-200 focus:border-amber-400 focus:ring-amber-400" required></textarea>
                </div>
                <div class="md:col-span-2">
                    @include('components.location-fields', [
                        'idPrefix' => 'distributor_company_location',
